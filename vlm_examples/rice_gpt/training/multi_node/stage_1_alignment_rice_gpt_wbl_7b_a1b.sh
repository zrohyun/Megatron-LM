...
CHECKPOINT_PATH="${TRAINING_PATH}/checkpoints/merged/vlm_20251231_wbl_llm_sft_1229_without_tulu_iter_0013500"

DEFAULT_OUTPUT_DIR="${TRAINING_PATH}/checkpoints/stage_1"
JOB_NAME="v12_rice_gpt_stage_1_7b_a1b_gbs_${GBS}_lr_2e_4_warmup_0_1_decay_0_01_no_moe_loss_tk_v5__vlm_20251231_wbl_llm_sft_1229_without_tulu_iter_0013500"
