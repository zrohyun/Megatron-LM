...
GBS=128
# NSTEP=2500
NSAMPLES=4200000    # 4,202,653

DATA_PATH="${TRAINING_PATH}/vlm/stage_x_dataset.yaml"
TOKENIZER_PATH="${TRAINING_PATH}/tokenizers/wbl_mm_tokenizer_v5"
CHECKPOINT_PATH="${TRAINING_PATH}/checkpoints/stage_4/checkpoints/v1_rice_gpt_stage_4_7b_a1b_gbs_128_lr_3e6_warmup_0_02_18M_tk5_no_capacity__v9__v6"

DEFAULT_OUTPUT_DIR="${TRAINING_PATH}/checkpoints/stage_x"
JOB_NAME="v2_rice_gpt_stage_x_7b_a1b_gbs_${GBS}_lr_1e5_vlrmult_0_1_warmup_0_05_decay_0_01_aux_1e3_tk5__v1__v9__v6"
