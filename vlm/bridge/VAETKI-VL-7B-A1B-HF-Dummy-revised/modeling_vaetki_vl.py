...
class VaetkiLayerNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        return (self.weight + 1) * hidden_states.to(input_dtype) + self.bias.to(input_dtype)
...
class RicePatchMerger(nn.Module):
    def __init__(self, dim: int, context_dim: int, spatial_merge_size: int = 2, layer_norm_eps: float = 1e-06) -> None:
        ...
        self.ln_q = VaetkiLayerNorm(context_dim, eps=layer_norm_eps)
