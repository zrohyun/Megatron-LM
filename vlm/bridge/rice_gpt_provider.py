...
from vlm.models.rice_gpt.rice_gpt_spec import get_vision_projector_layer_with_spec
...
def rice_gpt_model_provider_with_args(
    args,
    ...
    if args.num_experts:
        ...
        language_transformer_layer_spec = get_gpt_heterogeneous_layer_spec(config, use_te)
    else:
