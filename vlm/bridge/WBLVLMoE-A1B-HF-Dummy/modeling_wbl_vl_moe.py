...
from transformers.utils import auto_docstring, can_return_tuple, is_torch_flex_attn_available, is_torchdynamo_compiling, TransformersKwargs
...
class WBLRotaryEmbedding(nn.Module):
    def __init__(self, config: WBLVLMoETextConfig, device=None):
        super().__init__()
