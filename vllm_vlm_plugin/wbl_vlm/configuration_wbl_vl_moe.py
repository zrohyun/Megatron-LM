...
class WBLVLMoETextConfig(PretrainedConfig):
    model_type = "wbl_vl_moe_text"
...
class WBLVLMoEConfig(PretrainedConfig):
    r"""
    Args:
    ...
    sub_configs = {"vision_config": RiceConfig, "text_config": WBLVLMoETextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["WBLVLMoEConfig", "WBLVLMoETextConfig"]