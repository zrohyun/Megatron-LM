...
# Use the existing WBL configuration
from .configuration_wbl_vl_moe import WBLVLMoETextConfig as WBLConfig
...
def select_experts(
    ...
    num_fused_shared_experts: int | None = None,
...
FusedMoE.select_experts = staticmethod(select_experts)    # monkeypatch select_experts to remove grouped_topk logic
