...
export MASTER_ADDR=10.10.90.5 # IP
...
MOE_ARGS=(
    ...
    --moe-shared-expert-intermediate-size 1024 # 2048
    --moe-shared-expert-overlap
    --moe-router-padding-for-fp8
    --moe-router-load-balancing-type global_aux_loss
    --moe-router-topk 8
    --moe-grouped-gemm
    --moe-aux-loss-coeff 1e-3 #1e-4
...
DATA_ARGS=(
    ...
    --data-cache-path /home/Megatron-LM/storage/data/dataset_cache_merged_1024
)
